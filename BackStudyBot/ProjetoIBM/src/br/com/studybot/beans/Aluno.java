...
public class Aluno {
	...
	/**Classe para objetos do Classe para objetos do tipo Alunos, onde serão contidos, valores e métodos para o mesmo.
	 * @author André Pires
	 * @version 1.0
	...
	public Aluno(int int1, String string, String string2, String string3, String string4, String string5, int int2,
	 ...
	 /** Método para retorno da codigo do aluno
	...
	/** Método para retorno do apelido do aluno
	...
	/** Método para retorno do rg do aluno
	...
	/**
	 * Método para retorno do email do aluno
	 * @return String email
	 */
	...
	/**
	 * Método para retorno da senha do aluno
	 * @return String senha
	 */
 ...
 */
	...
	/**Metodo para retorno da data de formação.
	 * 
	 * @return Strind Data de Formação 
	 */
