...
/**
 * Classe que manipula os dados  da classe aula no banco de dados 
 * @author André
 *
 */
public class AulaDAO {
	...
	public String adicionar(Aula a1) throws Exception {
		...
		stmt = con.prepareStatement(
				"INSERT INTO T_STB_AULA (CD_AULA, NM_AULA, DS_DURACAO, CD_DISCIPLINA, CD_CURSO, CD_PROFESSOR) "
				+ "VALUES(?,?,?,?,?,?)");
		stmt.setInt(1, a1.getCodigo());
		stmt.setString(2, a1.getNome());
		stmt.setString(3, a1.getDescricao());
		stmt.setInt(4,a1.getProfessor().getCodigo());
