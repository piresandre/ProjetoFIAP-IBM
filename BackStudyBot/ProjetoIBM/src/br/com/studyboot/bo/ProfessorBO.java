...
public class ProfessorBO {
	/*
	 * Classe respons√°vel por manipular as regras relacionadas ao cadastro de aluno
	 * 
	 * codigo professor n√o pode ser < 1 nome deve conter no m√ximo 50 caracteres
	 * deve possuir apelido com no m√≠nimo 5 car√°cteres cpf deve conter 11
	 * caracteres rg deve conter 9 caracteres email deve conter @ sexo deve utilizar
	 * o caracter F para feminino e M para masculino senha deve possuir no m√≠nimo 6
	 * caracteres n√∫mero de telefone deve possuir 10 digitos 2 para ddd e 8 para o
	 * n√∫mero deve ser preenchido o codigo que comprove o numero de forma√ß√£o
	 *
	 * 
	 */
	public static String novoProfessor(Professor objProfessor) throws Exception {
		...
		if (objProfessor.getComprovantePagamento().length() < 30) {
			...
			return "Digite o 5 codigo de seu comprovante de formaÁ„o";
		}
