...
public class Aluno {
	...
	public Aluno(String historico, String grauEscolaridade, String dataFormacao,int codigo, String nome,
		String apelido, String rg,String cpf, String data, String email, int telefone, String senha, String sexo,
		int idade){
	...
	public void setCodigo(int cdAluno) {
		this.codigo = cdAluno;
	}
