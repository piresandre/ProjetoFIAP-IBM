...
public class ProfessorDAO {
	...
	public Professor buscaEmailSenha(String email, String senha)throws Exception {
		
		stmt=con.prepareStatement("SELECT * FROM T_STB_PROFESSOR WHERE DS_EMAIL=? AND NR_SENHA=?");
