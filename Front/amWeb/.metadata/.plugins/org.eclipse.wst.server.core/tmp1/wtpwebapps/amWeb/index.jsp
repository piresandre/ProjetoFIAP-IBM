...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#service">Especificacões</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="jumbotron">
          ...
          <p class="big">Tudo o que você precisa pra ir bem nos seus estudos.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="cta-1">
    <div class="container">
      <div class="row text-center white">
        <h1 class="cta-title">Diga olá para o STUDY[bot]</h1>
        <p class="cta-sub-title"><a data-toggle="modal" data-target="#modalChat">Clique aqui para tirar sua dúvida</a></p>
      </div>
    </div>
  </div>
        ...
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-text">
              ...
              <p> Lógica de Programação é a técnica de desenvolver algoritmos (sequências lógicas) para atingir determinados objetivos dentro de certas regras baseadas na Lógica matemática e em outras teorias.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-text">
              ...
              <p>Bancos de dados ou bases de dados são um conjunto de arquivos relacionados entre si com registros sobre pessoas, lugares ou coisas. São coleções organizadas de dados que se relacionam de forma a criar algum sentido e dar mais eficiência durante uma pesquisa ou estudo.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-text">
              ...
              <p>Diversas linguagens de programação surgiram desde então. Entre estas incluem-se C#, VB.NET, Java, Object Pascal, Objective-C, PHP, Python, SuperCollider, linguagem D e Ruby.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
  ...
  <div id="portfolio">
    <div class="container">
      <div class="page-title text-center">
        <h1>Conheça melhor os nossos cursos</h1>
        <hr class="pg-titl-bdr-btm"></hr>
      </div>
  ...
  <div id="contact" class="section-padding">
    <div class="container">
      <div class="row">
        ...
        <div class="form-sec">
          <form action="cadastraAluno" method="post" role="form" class="contactForm">
          	 ...
          	 <div class="col-md-4 form-group">
              <input type="date"  name="dataFormacao" id="dataFormacao" placeholder="Data de formação"/>
           ...
           <div class="col-md-4 form-group">
            ...
            <div class="col-md-4 form-group">
              <input type="text" class="form-control text-field-box" name="telefone" id="telefone" placeholder="Seu telefone" data-rule="email" data-msg="Por Favor valide seu e-mail" />
              <div class="validation"></div>
            </div>
            <div class="col-md-4 form-group">
              <input type="password" class="form-control text-field-box" name="senha" id="senha" placeholder="Senha" data-rule="email" data-msg="Por Favor valide seu e-mail" />
              <div class="validation"></div>
            </div>
            <div class="col-md-4 form-group">
            <select class="form-control" id="sexo" nome="sexo">
  		    ...
  		    <div class="col-md-4 form-group">
              <input type="text" class="form-control text-field-box" name="idade" id="idade" placeholder="Sua idade" data-rule="email" data-msg="Por Favor valide seu e-mail" />
              <div class="validation"></div>
            </div>
...
<div class="modal fade bd-example-modal-sm" id="modalChat" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
 ...
 <!--  fim da modal/ chat  -->
  ...
  <!-- não funciona  <script src="contactform/contactform.js"></script> -->
