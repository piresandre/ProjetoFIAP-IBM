...
<body>
  ...
  <div id="centro">
      ...
      <h1>ADMINISTRAR CURSOS/ALUNOS</h1>
      
       <hr class="pg-titl-bdr-btm"></hr>
			BEM VINDO PROFESSOR ${email}  </span></h1>
		...
		<!--  <div>
			Alunos:
			<ul>
			<c:forEach var="aluno" itens${alunos}">
  ...
  <footer class="footer section-padding">  <!-- footer siga-nos  -->
    ...
    <div class="footer-bottom"> <!-- rodapé com direitos reservados -->
    <div class="container">
